...
if ENV:
    ...
    HELP_IMG = os.environ.get("HELP_IMG", "https://graph.org/file/b3b4c0296eb557d47bd0a.mp4")
    STRICT_GBAN = bool(os.environ.get("STRICT_GBAN", True))
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "MPERILMENT_SUPPORT")
    ...
    try:
        ...
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "6722550550").split())
    except ValueError:
